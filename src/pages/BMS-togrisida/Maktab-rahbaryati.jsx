...
const MaktabRahbaryati = () => {
  return (
    ...
    <div className='bg-white max-w-[1000px] pt-[50px] m-auto'>
        <div className='p-10 md:flex items-center justify-between gap-10'>
          <div className=''>
           <img className='w-[600px] m-auto' src={Inogamova} alt="" />
          </div>
          <div className='mt-7 md:mb-10'>
            <h2 className='text-3xl font-bold'>Inogamova Nagisa Sagdullayevna</h2>
            <h3 className='text-2xl my-3 font-medium'>2-sonli bolalar musiqa va san’at maktabi O‘quv ishlari va ma'naviy-ma'rifiy ishlar bo‘yicha direktor o‘rinbosari </h3>
            <p className='text-xl'>Telefon: +998 94 669 85-25</p>
            <p className='text-xl my-1'>Qabul kunlari: Seshanba - 10:00 - 12:00</p>
            <p className='text-xl'>Payshanba - 15:00 - 17:00</p>
          </div>
